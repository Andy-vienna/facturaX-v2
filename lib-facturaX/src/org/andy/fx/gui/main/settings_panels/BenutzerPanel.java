...
public class BenutzerPanel extends JPanel {
    ...
    private final boolean[] selUser = {true,true,true,true,true,true,false,false,false,false,false,false,false};
    private final boolean[] selSuser = {true,true,true,true,true,true,true,true,true,true,false,false,false};
    private final boolean[] selFuser = {true,true,false,false,false,false,true,true,true,true,false,false,false};
    private final boolean[] selAdmin = {false,false,false,false,false,false,false,false,false,false,true,true,true};
    private final boolean[] selDefault = {false,false,false,false,false,false,false,false,false,false,false,false,false};
    ...
    private JCheckBox[] chkConfig = new JCheckBox[13];
    ...
    private void buildPanel() {
    	...
    	String[] config = { "Arbeitszeit", "Reisespesen", "Angebot", "Rechnung", "Bestellung", "Lieferschein", "Einkauf", "Betriebsausgaben",
    ...
    private final ActionListener cmbListener = new ActionListener() {
        ...
        public void actionPerformed(ActionEvent actionEvent) {
            ...
            if (idx == 0) {
                ...
                if (TabMask.visible(user.getTabConfig(), TabMask.Tab.TIME)) chkConfig[0].setSelected(true);
                if (TabMask.visible(user.getTabConfig(), TabMask.Tab.TRAVEL)) chkConfig[1].setSelected(true);
                if (TabMask.visible(user.getTabConfig(), TabMask.Tab.OFFER)) chkConfig[2].setSelected(true);
                if (TabMask.visible(user.getTabConfig(), TabMask.Tab.INVOICE)) chkConfig[3].setSelected(true);
                if (TabMask.visible(user.getTabConfig(), TabMask.Tab.ORDER)) chkConfig[4].setSelected(true);
                if (TabMask.visible(user.getTabConfig(), TabMask.Tab.DELIVERY)) chkConfig[5].setSelected(true);
                if (TabMask.visible(user.getTabConfig(), TabMask.Tab.PURCHASE)) chkConfig[6].setSelected(true);
                if (TabMask.visible(user.getTabConfig(), TabMask.Tab.EXPENSES)) chkConfig[7].setSelected(true);
                if (TabMask.visible(user.getTabConfig(), TabMask.Tab.TAX)) chkConfig[8].setSelected(true);
                if (TabMask.visible(user.getTabConfig(), TabMask.Tab.RESULT)) chkConfig[9].setSelected(true);
                if (TabMask.visible(user.getTabConfig(), TabMask.Tab.SETTINGS)) chkConfig[10].setSelected(true);
                if (TabMask.visible(user.getTabConfig(), TabMask.Tab.MIGRATION)) chkConfig[11].setSelected(true);
                if (TabMask.visible(user.getTabConfig(), TabMask.Tab.TRIALS)) chkConfig[12].setSelected(true);
            }
