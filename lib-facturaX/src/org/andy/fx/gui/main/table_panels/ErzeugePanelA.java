...
public class ErzeugePanelA extends JPanel {
	...
	public ErzeugePanelA(ErzeugeTabelle<Object> sPane, EditPanel editPanel, JButton[] buttons, SummenPanelA info) {
	...
	private void buildPanel(ErzeugeTabelle<Object> sPane, EditPanel editPanel, JButton[] buttons, SummenPanelA info) {
	...
	private JPanel createBottomPanel(JButton[] buttons, SummenPanelA info) {
		int i = 0;
